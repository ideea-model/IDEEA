...
ideea_sf <- get_ideea_map(nreg = 5, offshore = FALSE)

# select the pre-defined model
ideea_elc <- ideea_modules$electricity$reg5
...
### Solve base scenario
```{r, eval=params$solve}
scen_BY <- interpolate(mod, horizon = newHorizon(2020, rep(1, 1)))
