...
scen_REF_sub@path <- ideea_scenario_dir_name(
  name = "REF_sub", 
...
scen_CAP_sub@path <- ideea_scenario_dir_name(
  name = "CAP_sub", 
  model_name = mod@name, 
...
scen_REF@path <- ideea_scenario_name(
  name = "REF", 
  model_name = mod@name, 
  calendar_name = "d365_h24", 
  horizon_name = "2060"
...
scen_CAP@path <- ideea_scenario_dir_name(
  name = "CAP", 
  model_name = mod@name, 
  calendar_name = "d365_h24", 
  horizon_name = "2050"
...
```{r}
getData(sns, "vBalance", comm = "CO2", merge = T, digits = 1, drop.zeros = T) |> 
  # group_by(name, year) |> 
