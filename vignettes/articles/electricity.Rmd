...
scen_REF_sub <- interpolate_model(
  ...
  path = file.path("scenarios", glue(scen_REF_sub@name, "_r{nreg}")),
...
scen_CAP_sub <- interpolate(
  ...
  path = file.path("scenarios", glue(scen_CAP_sub@name, "_r{nreg}")),
...
vTechCap_agg <- vTechCap |>
  ...
  full_join(ideea_sf, by = c(region = regN),
...
vTechCap_ESOL_sf <-
  ...
  left_join(ideea_sol_cl_sf,
    by = c(region = regN, cluster = "cluster"),
    relationship = "many-to-many"
  ) |>
  rename(GW = value) |>
