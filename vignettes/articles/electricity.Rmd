...
if (packageVersion("energyRt") < '0.11.32') {
...
islands <- FALSE # should islands be included 
...
```{r regions}
gis_sf <- get_ideea_map(nreg, offshore = offshore, islands = islands,
                        rename = FALSE)
plot(gis_sf[regN_off], key.width = lcm(4.5))
```
...
# tsl2dtm(timetable_subset$slice, year = 2050) |> mday()
