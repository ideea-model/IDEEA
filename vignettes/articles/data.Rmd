...
```{r, eval=FALSE}
# TEMPORARY PATCH TO UPDATE MERRA2
devtools::load_all("C:/Users/admin/Documents/R/merra2ools")
get_merra2_dir()
set_merra2_options(merra2.arrow.dir = "D:/merra2_arrow2")

overwrite <- FALSE
# for (wyear in seq(2020, 1981, -1)) {
for (wyear in seq(2023, 2024, 1)) {
  # stop()
  ...
  merra <- merra |> 
    select(all_of(
      c("UTC", "locid", "W10M", "W50M", "WDIR", "T10M", "SWGDN", "ALBEDO", 
        "PRECTOTCORR", "RHOA")))
  message("Saving 'raw' data: ", fname)
  fst::write_fst(merra, path = fname, compress = 100)
  cat("File size:", gdata::humanReadable(file.size(fname)), "\n")
}
```
