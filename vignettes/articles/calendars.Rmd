...
# Save the calendars and horizons in IDEEA's data
...
save(calendars, horizons, file = here("data-raw/calendars.RData"))
# run 'calendars' chunk in 'data-raw/DATASET.R' and rebuild the package
